...
import { FaSearch, FaShoppingBag, FaUser, FaCog } from "react-icons/fa";
import { HiMenuAlt3, HiX } from "react-icons/hi";
import { usePathname, useRouter } from "next/navigation";
import { useCart } from "@/context/CartContext";
import { useSession, signOut } from "next-auth/react";
import { useIsAdmin } from "./admin/AdminGuard";
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem asChild>
                <Link
                  href="/profile"
                  className="cursor-pointer flex items-center space-x-2 px-3 py-2 hover:bg-gray-100"
                >
              ...
              {isAdmin && (
                <DropdownMenuItem asChild>
                  <Link
                    href="/admin"
                    className="cursor-pointer flex items-center space-x-2 px-3 py-2 hover:bg-gray-100 text-purple-600"
                  >
